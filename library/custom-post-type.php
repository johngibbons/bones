...
function custom_post_example() { 
	...
	register_post_type( 'unit', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 'labels' => array(
			...
			'search_items' => __( 'Search Units', 'bonestheme' ), /* Search Custom Type Title */ 
			'not_found' =>  __( 'Nothing found in the Database.', 'bonestheme' ), /* This displays if there are no entries yet */ 
			'not_found_in_trash' => __( 'Nothing found in Trash', 'bonestheme' ), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'This is where you create new unit types', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
	...
	*/
	...
	register_taxonomy( 'bedrooms', 
		array('unit'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
		array('hierarchical' => true,     /* if this is true, it acts like categories */
			'labels' => array(
				'name' => __( 'Number of Bedrooms', 'bonestheme' ), /* name of the custom taxonomy */
				'singular_name' => __( 'Bedrooms', 'bonestheme' ), /* single taxonomy name */
				'search_items' =>  __( 'Search Bedrooms', 'bonestheme' ), /* search title for taxomony */
				'all_items' => __( 'All Bedrooms', 'bonestheme' ), /* all title for taxonomies */
				'parent_item' => __( 'Parent Bedrooms', 'bonestheme' ), /* parent title for taxonomy */
				'parent_item_colon' => __( 'Parent Bedrooms:', 'bonestheme' ), /* parent taxonomy title */
				'edit_item' => __( 'Edit Bedrooms', 'bonestheme' ), /* edit custom taxonomy title */
				'update_item' => __( 'Update Bedrooms', 'bonestheme' ), /* update title for taxonomy */
				'add_new_item' => __( 'Add New Bedrooms', 'bonestheme' ), /* add new title for taxonomy */
				'new_item_name' => __( 'New No. of Bedrooms', 'bonestheme' ) /* name title for taxonomy */
			),
